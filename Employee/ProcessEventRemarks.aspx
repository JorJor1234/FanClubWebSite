<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ProcessEventRemarks.aspx.cs" Inherits="Employee_ProcessEventRemarks" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    <div class="form-horizontal">
        <h4><span style="text-decoration: underline; color: #FFFFFF">Process An Event Remark</span></h4>
        ...
        <asp:Panel ID="pnlEvents" runat="server">
            ...
            <div class="form-group">
                ...
                <div>
                    <asp:DropDownList ID="ddlEvents" runat="server" CssClass="dropdown col-md-9" AutoPostBack="True" ToolTip="Event" ForeColor="Black" OnSelectedIndexChanged="ddlEvents_SelectedIndexChanged" CausesValidation="True"></asp:DropDownList>
                </div>
                <div>
        ...
        <asp:Panel ID="pnlSubject" runat="server">
            <div class="form-group">
                ...
                <div>
                    <asp:DropDownList ID="ddlSubject" runat="server" CssClass="dropdown col-md-9" AutoPostBack="True" ToolTip="Subject" ForeColor="Black" OnSelectedIndexChanged="ddlSubject_SelectedIndexChanged" CausesValidation="True"></asp:DropDownList>
                </div>
                <div>
