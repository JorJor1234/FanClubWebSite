<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="EmployeeDefault.aspx.cs" Inherits="Employee_EmployeeDefault" %>

<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
        <div>
        <h4><span style="text-decoration: underline; color: #990000">Select An Employee Activity</span></h4>
        <p>
