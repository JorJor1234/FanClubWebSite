        ...
        <div class="col-md-8">
            <section id="loginForm">
                <div class="form-horizontal">
                    <h4><span style="text-decoration: underline; color: #FFFFFF">Log in</span></h4>
                    <hr />
                    ...
                    <div class="form-group">
                        <div class="col-md-10">
                            <asp:TextBox runat="server" ID="Password" TextMode="Password" CssClass="form-control" Visible="False">FanClub1#</asp:TextBox>
